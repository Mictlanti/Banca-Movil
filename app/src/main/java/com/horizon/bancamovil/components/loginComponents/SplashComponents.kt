package com.horizon.bancamovil.components.loginComponents
...
import com.horizon.bancamovil.data.AuthRes
...
@Composable
fun TwoView(navController: NavController, authManager: AuthManager) {
    ...
    Column(
        ...
        SignInWidth(signInOption, navController, authManager)
...
@Composable
private fun SignInWidth(signInOption: List<String>, navController: NavController, authManager: AuthManager) {
